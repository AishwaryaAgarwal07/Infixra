            ...
            <div className="bg-custom-name bg-cover mt-10  h-auto flex flex-row justify-center items-center  bg-no-repeat bg-center p-4 md:p-10   ">
                <div className=" flex flex-col w-full   justify-center items-center mt-10  ">
                    <div className=" p-5 flex flex-col justify-center ">
                        ...
                        <p className="text-xl mt-8  text-start text-serviceHeading">Industrial construction involves building structures for Industrial purposes, with a focus on functionality, efficiency, and meeting the needs of the business. 🏢🔨</p>
                    </div>
