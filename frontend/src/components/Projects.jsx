    ...
    <div className="border flex flex-col relative w-[30rem]  sm:w-[20rem]  sm:h-[25rem] md:h-[27rem]">
      ...
      <div className="m-6 flex justify-between ">
        <div className="flex flex-col space-y-3">
          <h1 className="text-secondary font-bold text-[1.7rem] sm:text-[2rem]">
            {title}
          </h1>
...
const Projects = () => {
  return (
    <section className="bg-white  p-4 sm:p-6 md:p-8 lg:p-10">
      ...
      <button className=" flex justify-center items-center   m-auto mt-9  bg-secondary text-white fond-bold w-72 border rounded-2xl p-2   drop-shadow-xl text-3xl font-extrabold hover:border-white ">
        {" "}
        More Projects
      </button>
    </section>
